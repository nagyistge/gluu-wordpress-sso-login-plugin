...
function oxd_openid_show_new_registration_page() {
    ...
    <form name="f" method="post" action="" id="register-form">
        ...
        <div class="oxd_openid_table_layout">
            ...
            <div class="mess_red">1. If You have not installed gluu server in Your web server, Please download, install and run gluu server. For more information <a target="_blank" href="http://www.gluu.org/docs/">click me</a>.</div>
            <div class="mess_red">2. Please download, install and run OXD server in Your web server. For more information <a target="_blank" href="http://ox.gluu.org/doku.php?id=oxd:rp">click me</a>.</div>
                    ...
                    <td>
                        <table style="width:100%">
                            <tr>
                                ...
                                <td>
                                <input type="checkbox" <?php if(!is_oxd_registered()) echo 'disabled'?>
                                id="Basic_enable" class="app_enable" name="oxd_openid_Basic_enable" value="1" onchange="previewLoginIcons();"
                                <?php checked( get_option('oxd_openid_Basic_enable') == 1 );?> /><strong>Basic</strong>
                                </td>
                                <td>
                                <input type="checkbox" <?php if(!is_oxd_registered()) echo 'disabled'?>
                                id="Duo_enable" class="app_enable" name="oxd_openid_Duo_enable" value="1" onchange="previewLoginIcons();"
                                <?php checked( get_option('oxd_openid_Duo_enable') == 1 );?> /><strong>Duo</strong>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td>
                        <table style="width:100%">
                            <tr>
                                <div class="mess_red">
                                    Sorry but Facebook, LinkedIn and Twitter custom scripts not yet ready.
                                </div>
                            </tr>
                            <tr>
                                <td><input type="checkbox" <?php echo 'disabled'?> id="facebook_enable" class="app_enable" name="oxd_openid_facebook_enable" value="1" onchange="previewLoginIcons();"
                                <?php checked( get_option('oxd_openid_facebook_enable') == 1 );?> /><strong>Facebook</strong>
                                </td>
                                <td>
                                <td><input type="checkbox" <?php  echo 'disabled'?> id="linkedin_enable" class="app_enable" name="oxd_openid_linkedin_enable" value="1" onchange="previewLoginIcons();"
                                <?php checked( get_option('oxd_openid_linkedin_enable') == 1 );?> /><strong>LinkedIn</strong>
                                </td>
                                <td>
                                <td><input type="checkbox" <?php echo 'disabled'?> id="twitter_enable" class="app_enable" name="oxd_openid_twitter_enable" value="1" onchange="previewLoginIcons();"
                                <?php checked( get_option('oxd_openid_twitter_enable') == 1 );?> /><strong>Twitter</strong>
                                </td>
...
<div>
    ...
    <img class="oxd_login_icon_preview" id="oxd_login_icon_preview_linkedin" src="<?php echo plugins_url( 'includes/images/icons/linkedin.png', __FILE__ )?>" />
    <img class="oxd_login_icon_preview" id="oxd_login_icon_preview_twitter" src="<?php echo plugins_url( 'includes/images/icons/twitter.png', __FILE__ )?>" />
    ...
    <img class="oxd_login_icon_preview" id="oxd_login_icon_preview_Basic" src="<?php echo plugins_url( 'includes/images/icons/Basic.png', __FILE__ )?>" />
    <img class="oxd_login_icon_preview" id="oxd_login_icon_preview_Duo" src="<?php echo plugins_url( 'includes/images/icons/Duo.png', __FILE__ )?>" />
</div>
...
<div>
    ...
    <a id="oxd_login_button_preview_linkedin" class="btn btn-block btn-defaulttheme btn-social btn-linkedin btn-custom-size"> <i class="fa fa-linkedin"></i><?php
                    echo get_option('oxd_openid_login_button_customize_text'); 	?> LinkedIn</a>
    <a id="oxd_login_button_preview_twitter" class="btn btn-block btn-defaulttheme btn-social btn-twitter btn-custom-size"> <i class="fa fa-twitter"></i><?php
    ...
    <a id="oxd_login_button_preview_U2F" class="btn btn-block btn-defaulttheme btn-social btn-U2F btn-custom-size"> <i class="fa fa-key"></i><?php
                    echo get_option('oxd_openid_login_button_customize_text'); 	?> U2F Token</a>
    <a id="oxd_login_button_preview_Basic" class="btn btn-block btn-defaulttheme btn-social btn-Basic btn-custom-size"> <i class="fa fa-retweet"></i><?php
                    echo get_option('oxd_openid_login_button_customize_text'); 	?> Basic</a>
    <a id="oxd_login_button_preview_Duo" class="btn btn-block btn-defaulttheme btn-social btn-Duo btn-custom-size"> <i class="fa fa-paper-plane-o"></i><?php
...
<div>
    ...
    <i class="oxd_custom_login_icon_preview fa fa-linkedin" id="oxd_custom_login_icon_preview_linkedin"  style="color:#ffffff;text-align:center;margin-top:5px;"></i>
    <i class="oxd_custom_login_icon_preview fa fa-twitter" id="oxd_custom_login_icon_preview_twitter"  style="color:#ffffff;text-align:center;margin-top:5px;"></i>
    ...
    <i class="oxd_custom_login_icon_preview fa fa-key" id="oxd_custom_login_icon_preview_U2F"  style="color:#ffffff;text-align:center;margin-top:5px;"></i>
    <i class="oxd_custom_login_icon_preview fa fa-retweet" id="oxd_custom_login_icon_preview_Basic" style="color:#ffffff;text-align:center;margin-top:5px;" ></i>
    <i class="oxd_custom_login_icon_preview fa fa-paper-plane-o" id="oxd_custom_login_icon_preview_Duo" style="color:#ffffff;text-align:center;margin-top:5px;"></i>
</div>
...
<div>
    <a id="oxd_custom_login_button_preview_facebook" class="btn btn-block btn-customtheme btn-social  btn-custom-size"> <i class="fa fa-facebook"></i><?php
                    echo get_option('oxd_openid_login_button_customize_text'); 	?> Facebook</a>
    <a id="oxd_custom_login_button_preview_linkedin" class="btn btn-block btn-customtheme btn-social  btn-custom-size"> <i class="fa fa-linkedin"></i><?php
                    echo get_option('oxd_openid_login_button_customize_text'); 	?> LinkedIn</a>
    <a id="oxd_custom_login_button_preview_twitter" class="btn btn-block btn-customtheme btn-social  btn-custom-size"> <i class="fa fa-twitter"></i><?php
                    echo get_option('oxd_openid_login_button_customize_text'); 	?> Twitter</a>
    <a id="oxd_custom_login_button_preview_google" class="btn btn-block btn-customtheme btn-social   btn-custom-size"> <i class="fa fa-google-plus"></i><?php
                    echo get_option('oxd_openid_login_button_customize_text'); 	?> Google</a>
    <a id="oxd_custom_login_button_preview_U2F" class="btn btn-block btn-customtheme btn-social   btn-custom-size"> <i class="fa fa-key"></i><?php
                    echo get_option('oxd_openid_login_button_customize_text'); 	?> U2F Token</a>
    <a id="oxd_custom_login_button_preview_Basic" class="btn btn-block btn-customtheme btn-social  btn-custom-size"> <i class="fa fa-retweet"></i><?php
                    echo get_option('oxd_openid_login_button_customize_text'); 	?> Basic</a>
    <a id="oxd_custom_login_button_preview_Duo" class="btn btn-block btn-customtheme btn-social  btn-custom-size"> <i class="fa fa-paper-plane-o"></i><?php
                    echo get_option('oxd_openid_login_button_customize_text'); 	?> Duo</a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div >
                                    <div>
                                        <input <?php if(!is_oxd_registered()) echo 'disabled'?> type="checkbox" name="scope[]" <?php if($options && in_array("openid", $options['scope'])){ echo "checked";} ?> id="openid" value="openid">
                                        <label  for="openid">OpenID</label>
                                        <input <?php if(!is_oxd_registered()) echo 'disabled'?> type="checkbox" name="scope[]" <?php if($options && in_array("profile", $options['scope'])){ echo "checked";} ?> id="profile" value="profile">
                                        <label  for="profile">Profile</label>
                                        <input <?php if(!is_oxd_registered()) echo 'disabled'?> type="checkbox" name="scope[]" <?php if($options && in_array("clientinfo", $options['scope'])){ echo "checked";} ?> id="clientinfo" value="clientinfo">
                                        <label  for="clientinfo">Client info</label>
                                        <input <?php if(!is_oxd_registered()) echo 'disabled'?> type="checkbox" name="scope[]" <?php if($options && in_array("phone", $options['scope'])){ echo "checked";} ?> id="phone" value="phone">
                                        <label  for="phone">Phone</label>
                                        <input <?php if(!is_oxd_registered()) echo 'disabled'?> type="checkbox" name="scope[]" <?php if($options && in_array("address", $options['scope'])){ echo "checked";} ?> id="address" value="address">
                                        <label  for="address">Address</label>
                                        <input <?php if(!is_oxd_registered()) echo 'disabled'?> type="checkbox" name="scope[]" <?php if($options && in_array("email", $options['scope'])){ echo "checked";} ?> id="email" value="email">
                                        <label  for="email">Email</label>
                                        <input <?php if(!is_oxd_registered()) echo 'disabled'?> type="checkbox" name="scope[]" <?php if($options && in_array("Basic_phone", $options['scope'])){ echo "checked";} ?> id="Basic_phone" value="Basic_phone">
                                        <label  for="Basic_phone">Mobile phone</label>
                                    </div>
                                </div>
                            </td>
                        </tr>
		...
		<table>
									...
									<tr>
										<td>
											...
											<br>
											<code>&lt;&#63;php echo do_shortcode('[gluu_login theme="default"]') &#63;&gt;</code></div>
											<hr>
